...
public class SubscriptionManagerImpl implements SubscriptionManager {
    ...
    public final static String module = SubscriptionManagerImpl.class.getName();
    
    private IMPresenceHolder presenceHolder;
    private RosterListRepositoryHolder rosterListReposityHolder;
    private ServerParameters serverParameters;
    
    public SubscriptionManagerImpl(IMPresenceHolder presenceHolder, RosterListRepositoryHolder rosterListReposityHolder, ServerParameters serverParameters) {
        this.presenceHolder = presenceHolder;
        this.rosterListReposityHolder = rosterListReposityHolder;
