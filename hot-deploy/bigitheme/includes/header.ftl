    ...
    <ul>
      ...
      <#if headerImageUrl?exists>
        <#if organizationLogoLinkURL?has_content>
            ...
            <#else>
            <li class="logo-area"><a href="<@ofbizUrl>${logoLinkURL}</@ofbizUrl>"><img height="30" width="100" alt="${layoutSettings.companyName}" src="<@ofbizContentUrl>${StringUtil.wrapString(headerImageUrl)}</@ofbizContentUrl>"/></a></li>
        </#if>
      </#if>
