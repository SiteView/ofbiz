...
<#list topMenus as topMenu>
    ...
    <PortalPage portalPageId="${topMenu.menuId}" description="${topMenu.description?if_exists}" ownerUserLoginId="_NA_" parentPortalPageId="${webSiteId}" portalPageName="${topMenu.menuName}" rootContentId="${topMenu.menuId}" sequenceNum="${topMenu.sequenceNum}"/> 
    <PortalPageColumn portalPageId="${topMenu.menuId}" columnSeqId="left" columnWidthPixels="180"/>
    <PortalPageColumn portalPageId="${topMenu.menuId}" columnSeqId="mainarea"/> 
    
    <PortalPagePortlet portalPageId="${topMenu.menuId}" columnSeqId="left" portalPortletId="GenericScreen" portletSeqId="left01" sequenceNum="10"/> 
    <PortalPagePortlet portalPageId="${topMenu.menuId}" columnSeqId="left" portalPortletId="GenericScreen" portletSeqId="left02" sequenceNum="20"/> 
    <PortletAttribute portalPageId="${topMenu.menuId}" portalPortletId="GenericScreen" portletSeqId="left01" attrName="screenLocation" attrValue="component://bigit/widget/ContentScreens.xml" /> 
    <PortletAttribute portalPageId="${topMenu.menuId}" portalPortletId="GenericScreen" portletSeqId="left01" attrName="screenName" attrValue="subPortalPageList" /> 
    <PortletAttribute portalPageId="${topMenu.menuId}" portalPortletId="GenericScreen" portletSeqId="left02" attrName="screenLocation" attrValue="component://bigit/widget/ForumScreens.xml" /> 
    <PortletAttribute portalPageId="${topMenu.menuId}" portalPortletId="GenericScreen" portletSeqId="left02" attrName="screenName" attrValue="forums" /> 
    
    <PortalPagePortlet portalPageId="${topMenu.menuId}" columnSeqId="mainarea" portalPortletId="GenericScreen" portletSeqId="main01" sequenceNum="10"/> 
    <PortletAttribute portalPageId="${topMenu.menuId}" portalPortletId="GenericScreen" portletSeqId="main01" attrName="screenLocation" attrValue="component://bigit/widget/ContentScreens.xml" /> 
    <PortletAttribute portalPageId="${topMenu.menuId}" portalPortletId="GenericScreen" portletSeqId="main01" attrName="screenName" attrValue="subPortalPageHead" /> 
    <PortalPagePortlet portalPageId="${topMenu.menuId}" columnSeqId="mainarea" portalPortletId="GenericPortalPage" portletSeqId="main02" sequenceNum="20"/> 
