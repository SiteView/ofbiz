  ...
  <div class="screenlet-body">
    <form method="post" action="<@ofbizUrl>login</@ofbizUrl>" name="loginform" class="horizontal">
      <fieldset>
        ...
        <div>
          <input type="submit" class="button" name= "OFBIZ_LOGIN" value="${uiLabelMap.CommonLogin}"/>
          <input type="submit" class="button" name= "QQ_LOGIN" value="${uiLabelMap.CommonQQLogin}"/>
          <input type="submit" class="button" name= "WEIBO_LOGIN" value="${uiLabelMap.CommonWeiboLogin}"/>
        </div>
        <div>
          <label for="newcustomer_submit">${uiLabelMap.CommonMayCreateNewAccountHere}:</label>
          <a href="<@ofbizUrl>newcustomer</@ofbizUrl>">${uiLabelMap.CommonMayCreate}</a>
