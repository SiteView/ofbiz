 ...
 * CrowdAuthenticator
 */
public class SocialAuthenticator extends SocialAuthWorker implements Authenticator {

    private static final String module = SocialAuthenticator.class.getName();
