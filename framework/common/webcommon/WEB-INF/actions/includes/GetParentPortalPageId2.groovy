...
if (parameters.parentPortalPageId && !parameters.portalPageId) {
    ...
    condSec = EntityCondition.makeCondition([
            ...
            EntityCondition.makeCondition("userLoginId", EntityOperator.EQUALS, "DemoCustomer")
            ],EntityOperator.AND);
    ...
    if (portalMainPages) {
        ...
        privatMainPages = delegator.findByAnd("PortalPage", [originalPortalPageId : portalPageId, ownerUserLoginId : "DemoCustomer"], null, false);
        if (privatMainPages) {
